...
public class InitDbService {
	...
	public void addInitData() {
		Student student1 = saveNewStudent("student1", LocalDate.of(2000, 10, 10), 1, 10);
		Student student2 = saveNewStudent("student2", LocalDate.of(2000, 10, 10), 2, 11);
		Student student3 = saveNewStudent("student3", LocalDate.of(2000, 10, 10), 3, 12);
